...
//        verticalArrangement = Arrangement.Center,
        ...
        Column(
            ...
            Row {
                Text(text = "Wellcome Back ", fontSize = 20.sp, fontWeight = FontWeight.Bold, color = mauChuPhu)
                Text(
                    text = " Huynh Hoa",
                    fontSize = 21.sp,
            ...
            OutlinedTextField(
                ...
                label = { Text(text = "Password", color = mauNhanChinh) }, // ++ THAY ĐỔI
            ...
            Button(
                ...
                Text(text = "Sign In", fontWeight = FontWeight.Bold, fontSize = 20.sp, color = Color.White)
            }
            ...
            Row(
                ...
                Text(text = "Is it first for you? ", textAlign = TextAlign.Center, color = mauChuPhu)
                TextButton(
                    onClick = {
            ...
            Row(modifier = Modifier.fillMaxWidth(), Arrangement.Center) {
                Text(text = "OR Sign In with", color = mauChuPhu)
            }
